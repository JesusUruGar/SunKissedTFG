...
<nav class="bg-white">
    <div class="mx-auto px-5 py-2 flex justify-between items-center">
        ...
        <ul class="flex space-x-7 text-m font-medium">
            <li><a href="{{ route('home') }}" class="hover:text-orange-600 hover:border-b-2">HOME</a></li>
            <li><a href="{{ route('brand') }}" class="hover:text-orange-600 hover:border-b-2">BRAND</a></li>
            <li><a href="{{ route('faqs') }}" class="hover:text-orange-600 hover:border-b-2">FAQS</a></li>
        </ul>

        <ul class="flex space-x-4 my-2">

            <!-- ADMIN PANEL -->
            <li><a href="{{ route('admin.dashboard') }}" class="hover:text-orange-600">
            ...
            <!-- USER -->
            <li><a href="{{ route('user') }}" class="hover:text-orange-600">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5.5">
