...
<div class="container mx-auto px-4 py-10">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center space-x-1.5">
                    ...
                    <a href="{{ route('admin.orders') }}" class="inline-flex items-center text-sm font-medium text-body hover:text-fg-brand">
                        Pedidos
                    </a>
                </div>
            </li>
            <li aria-current="page">
                <div class="flex items-center space-x-1.5">
                    <svg class="w-3.5 h-3.5 rtl:rotate-180 text-body" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"/></svg>
                    <span class="inline-flex items-center text-sm font-medium text-body-subtle">Gestionar pedido</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <!-- TITLE -->
    <h1 class="text-4xl font-bold">Gestionar pedido</h1>

    <!-- FORM -->
    <div class="shadow-md p-6 mt-6">

        <form action="{{ route('admin.orders.update-status', ['id' => $order->id]) }}" method="POST" enctype="multipart/form-data" class="mx-auto">
            ...
            <div class="mb-5 max-w-md">
                ...
                <select id="status" name="status" class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body" required>
